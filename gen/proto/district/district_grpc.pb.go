...
const (
	DistrictService_Create_FullMethodName  = "/district.DistrictService/Create"
	DistrictService_GetById_FullMethodName = "/district.DistrictService/GetById"
	DistrictService_Get_FullMethodName     = "/district.DistrictService/Get"
	DistrictService_Update_FullMethodName  = "/district.DistrictService/Update"
	DistrictService_Delete_FullMethodName  = "/district.DistrictService/Delete"
)
...
func (c *districtServiceClient) GetById(ctx context.Context, in *ByIdRequest, opts ...grpc.CallOption) (*District, error) {
	out := new(District)
	err := c.cc.Invoke(ctx, DistrictService_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DistrictService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DistrictService_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
